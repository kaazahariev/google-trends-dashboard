...
import type { ParsedRelatedTopics } from "@/types/trends";
import { CHART_COLORS } from "@/lib/constants";

interface Props {
  data: Record<string, ParsedRelatedTopics>;
  keywords: string[];
}

export function RelatedTopicsCard({ data, keywords }: Props) {
